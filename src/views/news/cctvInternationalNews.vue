<template>
  <div>
    <div class="container" v-if="newsData.length">
      ...
      <header>
        <h1><i class="fas fa-newspaper"></i> CCTV国际新闻</h1>
...
export default {
  ...
  methods: {
    ...
    getNewsInfo() {
      https://api.istero.com/resource/v1/cctv/world/latest/news
      axios
        .get(`/yyy/v1/cctv/world/latest/news?token=${this.globalConfig.token_news}`)
        .then(res => {
          console.log('cctv国际新闻res === ', res)
