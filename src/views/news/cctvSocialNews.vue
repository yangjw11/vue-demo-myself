<template>
  <div>
    <div class="container" v-if="newsData.length">
      ...
      <header>
        <h1><i class="fas fa-newspaper"></i> CCTV社会新闻</h1>
...
export default {
  ...
  methods: {
    ...
    getNewsInfo() {
      https://api.istero.com/resource/v1/cctv/society/latest/news
      axios
        .get(`/yyy/v1/cctv/society/latest/news?token=${this.globalConfig.token_news}`)
        .then(res => {
          console.log('cctv社会新闻res === ', res)
