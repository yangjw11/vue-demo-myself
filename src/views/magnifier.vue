...
export default {
  ...
  methods: {
    mousemove(e) {
      ...
      // 第一步获取鼠标中点位置
      let maskX = e.clientX - small.offsetLeft
      let maskY = e.clieY - small.offsetTop
